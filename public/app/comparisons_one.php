<script src="./app/js/comparisons_one.js"></script>
 <!-- top tiles -->
...
<div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div xclass="x_panel">
                  <div class="x_title ">
                  <h2>Combined Utilities ( <span id="thismonth"></span> )</h2>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <div id="isdownload" class="btn-group" data-toggle="buttons">
                              <label class="btn btn-default" data-toggle-class="btn btn-success" xdata-toggle-passive-class="btn-default">
            ...
            <div class="modal-footer">               
                <button type="button" class="btn btn-success" id="save" value="save" name="submit">Compare</button>
