...
return new Date(year, 1, 1).getTime();
	...
	var arr_data1 = [
		[gd(2012, 2, 2), 61149713],
		[gd(2012, 24, 24), 67071191]
		/*[39,		2771610	],
	[30,		2924598	],
	[36,		1990950	],
	[0	,	5036975	],
...
/*	var arr_data2 = [
		[gd(2012, 13, 13), 67797526],
		[gd(2012, 20, 20), 66339117],
		[gd(2012, 22, 22), 67455764],		
		[gd(2012, 46, 46), 63276158],
			[gd(2012, 48, 48), 53081536]
	...
	for (var i = 0; i < 30; i++) {
	  chart_plot_02_data.push([new Date() + 10000]);
	}
	...
	var chart_plot_01_settings = {
	  ...
	  yaxis: {
					axisLabel: "Total Sum Utility Code",
		ticks: 8,
		tickColor: "rgba(51, 51, 51, 0.06)",
	  },
	  tooltip: false
...
$.plot( $("#chart_plot_01"),  chart_plot_01_settings );
	}
